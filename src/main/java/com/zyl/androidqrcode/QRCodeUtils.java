...
/**
 * 二维码工具类
 * Created by zyl on 16/4/20.
 */
public class QRCodeUtils {
    private static int IMAGE_HALFWIDTH = 50;//宽度值，影响中间图片大小

    private QRCodeUtils(){}
    private static class QRCodeUtilsHolder{
        private final static QRCodeUtils INSTANCE = new QRCodeUtils();
    }
    public static QRCodeUtils getInstance(){
        return QRCodeUtilsHolder.INSTANCE;
    }
